          ...
          <ul>
            <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
              ...
              >
                ...
                📣
                <span className="font-medium text-slate-800 dark:text-slate-100 mr-1">Dashboard created</span>
                  The developer of this dashboard created it as an interview project
                </span>
                <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">March 2, 2024</span>
              </Link>
            </li>
          </ul>
        </div>
